...
SELECT COUNT(founder) FROM schools WHERE founder='Rīgas valstspilsētas pašvaldība';
SELECT DISTINCT founder FROM schools;
SELECT name,class_12 FROM schools ORDER BY class_12 DESC LIMIT 5;
SELECT name,class_10 FROM schools ORDER BY class_10 ASC LIMIT 5;
SELECT name,class_10+class_11+class_12 AS sum_of_columns FROM schools ORDER BY sum_of_columns DESC;